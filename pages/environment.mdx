...
If you're more interested in server-side development than building websites, consider using `node.js`, a command line application for running JavaScript on your computer. You can download and install the application from [the node website](https://nodejs.org).

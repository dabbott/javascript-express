...
Keys can only be strings, although we can restrict the set of allowed keys (e.g. to numbers) using type annotations — non-string keys will be coerced to strings at runtime.

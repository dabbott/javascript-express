import arrayType from '../../examples/files/types/arrayType'
import objectType from '../../examples/files/types/objectType'
import functionType from '../../examples/files/types/functionType'
import intendedPurpose from '../../examples/files/types/intendedPurpose'
...
Keys can only be strings (or symbols)<Details condition={IS_TYPESCRIPT}>, although we can restrict the set of allowed keys (e.g. to numbers) using type annotations</Details> — non-string keys will be coerced to strings at runtime.
...
<Example title={'Objects'} code={objectType} />
...
<Example title={'Arrays'} code={arrayType} />
...
<Example title={'Functions'} code={functionType} />
...
<Example title={'Intended purposes'} code={intendedPurpose} />

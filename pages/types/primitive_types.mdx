import literals from '../../examples/files/types/literals'
import primitiveConstructors from '../../examples/files/types/primitiveConstructors'
import primitiveMethods from '../../examples/files/types/primitiveMethods'
import primitiveCasting from '../../examples/files/types/primitiveCasting'
...
- `null`
- `Boolean`
- `Number` ([double-precision 64-bit binary format IEEE 754](https://en.wikipedia.org/wiki/Floating-point_arithmetic))
- `String`
- `BigInt`
- `Symbol`

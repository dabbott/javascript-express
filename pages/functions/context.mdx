...
This is the main use case for `this`.<Details condition={IS_TYPESCRIPT}> Depending on your TypeScript compiler settings, you can force the type of `this` to be defined, which helps avoid errors.</Details>

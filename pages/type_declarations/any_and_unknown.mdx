...
Many standard library functions use `any`, but we should generally use `unknown` instead.<Details> Unknown is relatively new - otherwise more standard library functions would probably use it.</Details>
